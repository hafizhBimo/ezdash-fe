...
const DeadStockPage = () => {
  ...
  const fetchConsignmentData = async () => {
    ...
    try {
      const params = {
        ...
        dead_stock_filter: deadStockFilter,
        sortBy,
        sortOrder
      };
  ...
  }, [selectedUpload, page, pageSize, searchText, warehouse, vendor, stockType, deadStockFilter, sortBy, sortOrder]);
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <div>
        <Title level={2}>Dead Stock & Overstock</Title>
        <Paragraph>Laporan barang-barang yang menumpuk lama di gudang atau tidak terjual/terpakai, berdasarkan threshold umur stok dari Settings.</Paragraph>
      </div>
      ...
      <Card className="glass-card">
        <Space direction="vertical" size="middle" style={{ width: '100%' }}>
          ...
          <Row gutter={[8, 8]} justify="start">
            ...
            <Col xs={12} sm={6} md={5}>
              <Select 
                placeholder="Tipe Overstock" 
                value={deadStockFilter} 
                onChange={setDeadStockFilter} 
                style={{ width: '100%' }}
              >
                <Option value="ALL">Semua Overstock & Dead Stock</Option>
                <Option value="OVERSTOCK">Overstock Saja</Option>
                <Option value="DEADSTOCK">Dead Stock Saja</Option>
              </Select>
            </Col>
