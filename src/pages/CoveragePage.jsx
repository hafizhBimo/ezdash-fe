...
const CoveragePage = () => {
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <div>
        <Title level={2}>Coverage (Days of Stock)</Title>
        <Paragraph>Laporan ketahanan umur stok gudang berdasarkan riwayat pemakaian, diurutkan dari yang paling kritis.</Paragraph>
      </div>
